...
window.lang = "es";
window.window.idioma = "es";
window.window.idioma_actual = "es";

window.idioma_2 = "en";
window.idioma_2_text = "Go to English Version";

window.url_works = "trabajos/";
window.contact_url = "contacto/";
window.img_trab_url = "/src/components/Global/media";

window.url_home = "welcome/";
window.url_works_switch = "works/";
...
window.ponele = document.getElementById('header');
